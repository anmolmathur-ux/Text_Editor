            ...
            {activeTab === 'generate' ? (
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-violet-500 to-purple-600 text-white hover:opacity-90"
                >
                  {isGenerating ? (
                    <>
                ...
                {generatedPreview && (
                  ...
                  >
                    ...
                    <div className="mt-1.5 p-3 bg-secondary rounded-lg text-sm max-h-[200px] overflow-y-auto">
